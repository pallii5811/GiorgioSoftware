...
ok(mapsNameVariants(pineta).some((v) => v.includes("Pineta Grande")), "varianti Pineta");
...
ok(
  mapsMatchScore(pineta, "Pineta Grande Hospital") > mapsMatchScore(pineta, "Villa Esther"),
  "preferisce ospedale principale vs filiale"
);
const picked = pickOfficialWebsite(
  ["https://www.pinetagrande.it/", "http://www.villaesther.com/"],
  pineta
);
ok(picked?.includes("pinetagrande"), "pickOfficialWebsite preferisce sede principale");
ok(
