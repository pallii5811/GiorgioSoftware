...
for (const c of cases) {
  ...
  console.log(JSON.stringify({ name: c.name, doc, facDomain: fac.domain, attr, pubSignals: { strong: pub.hasStrongInsuranceSignal, medium: pub.hasMediumInsuranceSignals, entity: pub.entityAttributed, source: pub.sourceClass }, gate }, null, 2));
}
TS
