...
export function readCrawlBudgetConfig(
  ...
  return {
    ...
    runMaxWallClockMs: overrides.runMaxWallClockMs ?? num("CRAWL_RUN_MAX_WALL_CLOCK_MS", 2_700_000),
    ...
    pdfFetchTimeoutMs: overrides.pdfFetchTimeoutMs ?? num("PDF_FETCH_TIMEOUT_MS", 60_000),
    ocrTimeoutMs: overrides.ocrTimeoutMs ?? num("OCR_TIMEOUT_MS", 180_000),
    ...
    maxDocumentRetries: overrides.maxDocumentRetries ?? num("MAX_DOCUMENT_RETRIES", 3),
    ...
    maxHtmlPerSlice: overrides.maxHtmlPerSlice ?? num("CRAWL_MAX_HTML_PER_SLICE", 24),
  };
}
